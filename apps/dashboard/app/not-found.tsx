...
import { Home, Search, Compass, Sparkles, Zap, ArrowLeft } from 'lucide-react';
...
export default function RootNotFound() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-blue-400/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-purple-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] h-[320px] sm:w-[480px] sm:h-[480px] md:w-[600px] md:h-[600px] bg-primary/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="relative z-10 max-w-4xl w-full mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <div className="relative mb-8">
            <h1
              className="text-[96px] sm:text-[180px] md:text-[240px] font-black leading-none bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent select-none"
              style={{
          ...
          >
            ...
            <button
              type="button"
              id="go-back-btn"
              className="w-full sm:w-auto min-w-[220px] h-12 text-base font-semibold border-2 border-input bg-background hover:bg-accent hover:text-accent-foreground rounded-md px-4 py-2 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2"
            >
